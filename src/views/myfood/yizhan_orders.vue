...
<template>
  ...
  <div style="margin-bottom: 70px;" class="order-container " ref="containerRef" >
    ...
    >
      ...
      <p style="height: 13px; padding-bottom:0px ; margin-bottom: 0px;">总金额: {{ order.totalAmount.toFixed(2) }} 元 ,  其中运费：{{ order.totalYunfei.toFixed(2) }}</p>

      <p>总数量: {{ order.totalQuantity }}</p>
